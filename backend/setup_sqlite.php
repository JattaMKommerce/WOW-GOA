...
// Hotels
$stmt = $pdo->prepare("INSERT OR REPLACE INTO hotels (id, name, area, location, price, stars, amenities, rating, badge, image) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
$stmt->execute(['hotel-1', 'Taj Exotica Resort & Spa', 'South Goa (Benaulim)', 'Benaulim, Goa', 18000, 5, 'Private Beach, Infinity Pool, Luxury Spa, 24x7 Dining', 4.90, '5-Star Luxury', 'https://images.unsplash.com/photo-1566073771259-6a8506099945?auto=format&fit=crop&w=800&q=80']);
$stmt->execute(['hotel-2', 'W Goa', 'North Goa (Vagator)', 'Vagator, Goa', 22000, 5, 'Rock Pool, Premium Club, Ocean View, Vibrant Vibe', 4.80, 'Ultra Premium', 'https://images.unsplash.com/photo-1540555700478-4be289fbecef?auto=format&fit=crop&w=800&q=80']);
$stmt->execute(['hotel-3', 'Whispering Palms Beach Resort', 'North Goa (Candolim)', 'Candolim, Goa', 7500, 4, 'Close to Beach, Swimming Pool, All-Inclusive Plan, Bar', 4.50, 'Best Family Choice', 'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?auto=format&fit=crop&w=800&q=80']);
$stmt->execute(['hotel-4', 'Lemon Tree Amarante Beach Resort', 'North Goa (Candolim)', 'Candolim, Goa', 6800, 4, 'Heritage Architecture, Spa, Poolside Bar, Wi-Fi', 4.40, 'Highly Rated', 'https://images.unsplash.com/photo-1584132967334-10e028bd69f7?auto=format&fit=crop&w=800&q=80']);
$stmt->execute(['hotel-5', 'Cidade de Goa - IHCL SeleQtions', 'Central Goa (Dona Paula)', 'Panaji, Goa', 12500, 5, 'Oceanfront, Water Sports, Kids Play Area, Fine Dining', 4.70, 'Beachfront View', 'https://images.unsplash.com/photo-1571896349842-33c89424de2d?auto=format&fit=crop&w=800&q=80']);
$stmt->execute(['hotel-6', 'Alila Diwa Goa', 'South Goa (Majorda)', 'Majorda, Goa', 14000, 5, 'Paddy Field View, Infinity Pool, Spa Alila, Kids Club', 4.80, 'Luxury Eco Resort', 'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&w=800&q=80']);
$stmt->execute(['hotel-7', 'Fairfield by Marriott Goa Anjuna', 'North Goa (Anjuna)', 'Anjuna, Goa', 5500, 4, 'Outdoor Pool, Fitness Center, Kava Restaurant, Free WiFi', 4.40, 'Great Value', 'https://images.unsplash.com/photo-1590490360182-c33d57733427?auto=format&fit=crop&w=800&q=80']);
$stmt->execute(['hotel-8', 'The Leela Goa', 'South Goa (Cavelossim)', 'Cavelossim, Goa', 24000, 5, '12-Hole Golf Course, Private Lagoon, 7 Dining Venues', 4.95, 'Ultra Luxury', 'https://images.unsplash.com/photo-1578683010236-d716f9a3f461?auto=format&fit=crop&w=800&q=80']);

// Packages
$stmt = $pdo->prepare("INSERT OR REPLACE INTO packages (id, name, duration, car_included, hotel_included, price, description, tag, image, package_type, flights_included, food_included, pickup_drop_included, places_included, price_with_flight) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
$stmt->execute(['package-1', 'Coastal Goa Explorer Pack', '4 Days / 3 Nights', 'Mahindra Thar 4x4', '4-Star Candolim Beach Resort', 14999, 'Explore the sun-kissed beaches of North Goa with a premium 4x4 Thar at your disposal and stays next to the lively coast.', 'Most Popular', 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=800&q=80', 'Trip Package', '1', 'Breakfast Included', 'Free Airport Pickup & Drop', 'Calangute, Baga, Candolim, Fort Aguada', 18999]);
$stmt->execute(['package-2', 'Romantic Sunset Escape', '3 Days / 2 Nights', 'Audi Cabriolet Convertible', 'W Goa Luxury Resort (Vagator)', 29999, 'Drive in style under the open skies with a luxury convertible. Includes a candlelight beach dinner and a couples spa.', 'Luxury Honeymoon', 'https://images.unsplash.com/photo-1533759413974-9e15f3b745ac?auto=format&fit=crop&w=800&q=80', 'Trip Package', '1', 'All Meals & Candlelight Dinner', 'Vagator, Anjuna, Chapora Fort', 34999]);
$stmt->execute(['package-3', 'Bike & Backpack Heritage Trail', '3 Days / 2 Nights', 'Royal Enfield Classic 350', 'Cidade de Goa Boutique Stay', 5499, 'Embark on a rustic heritage ride through ancient forts, Latin quarters, and spice plantations on classic motorbikes.', 'Adventure Seekers', 'https://images.unsplash.com/photo-1558981806-ec527fa84c39?auto=format&fit=crop&w=800&q=80', 'Self Drive Package', '0', 'Breakfast Included', 'Panaji Latin Quarter, Old Goa Churches, Reis Magos', 8999]);
$stmt->execute(['package-4', 'Ultimate Goa Cruise & Drive', '5 Days / 4 Nights', 'Toyota Fortuner Automatic', 'Taj Exotica Resort & Spa', 64999, 'The peak Goa vacation. Large premium SUV, 5-Star beach resort, and a private 2-hour yacht cruise over the Chapora River.', 'Elite VVIP', 'https://images.unsplash.com/photo-1567818735868-e71b99932e29?auto=format&fit=crop&w=800&q=80', 'Trip Package', '1', 'All Inclusive Luxury Dining', 'Benaulim, Colva, Palolem, Panaji Yacht Marina', 74999]);
$stmt->execute(['package-5', 'Self Drive Beach Hopper Goa', '4 Days / 3 Nights', 'Hyundai Creta Automatic', 'Whispering Palms Beach Stay', 12499, 'Enjoy complete freedom exploring both North and South Goa at your own pace with a comfortable SUV.', 'Self Drive', 'https://images.unsplash.com/photo-1512343879784-a960bf40e7f2?auto=format&fit=crop&w=800&q=80', 'Self Drive Package', '1', 'Breakfast Included', 'Morjim, Ashwem, Arambol, Sinquerim', 16499]);
$stmt->execute(['package-6', 'South Goa Serenity & Watersports', '4 Days / 3 Nights', 'Maruti Suzuki Swift', 'Alila Diwa 5-Star Resort', 17999, 'Relax on pristine white sand beaches of South Goa with jet skiing, parasailing, and dolphin spotting included.', 'Family Fun', 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&w=800&q=80', 'Trip Package', '1', 'Breakfast & Watersports Pass', 'Majorda, Cavelossim, Benaulim', 21999]);
